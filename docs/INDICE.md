...
- **Web client (Try it)**: https://arkham-im.fly.dev/ · https://blackgate-im.fly.dev/ (Fly)
...
- [architecture/gotham-protocol.md](./architecture/gotham-protocol.md) — contratto wire federazione (HTTP/3, Protobuf, wire identity, media, outbox/spunte)
- [domain/federation/README.md](./domain/federation/README.md) — indice modello federazione (obiezioni #1–#6)
