...
| Tipo | SSOT |
|------|------|
| **Principio ADR** (questa cartella) | File `*.md` sotto — indirizzo, cloud reception, multi-account |
...
| [no-internal-external-chat-distinction.md](./no-internal-external-chat-distinction.md) | Nessuna distinzione chat locale/federata in UI |
