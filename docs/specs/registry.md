...
|-------------|--------|-------|------|
| **SYS-MAILBOX** | Archivio per titolare archivio, invio, inbox on-read, spunte — **`peer_address` / `author_address`** | `implemented` | [SYS-MAILBOX.md](./promises/system/SYS-MAILBOX.md) |
| **SYS-GROUP** | Account gruppo, partecipazione, erogazione — identità address-based §7.18 | `implemented` | [SYS-GROUP.md](./promises/system/SYS-GROUP.md) |
| **SYS-PROFILE** | Tabella `profiles`, avatar, **`get_profiles(addresses[])`** | `implemented` | [SYS-PROFILE.md](./promises/system/SYS-PROFILE.md) |
| **SYS-CONTACTS** | Rubrica `contacts.address` only | `implemented` | [SYS-CONTACTS.md](./promises/system/SYS-CONTACTS.md) |
| **SYS-RECEPTION** | Allow list **`allowed_address`**, gate su indirizzo | `implemented` | [SYS-RECEPTION.md](./promises/system/SYS-RECEPTION.md) |
...
| **SYS-PUSH-PAYLOAD** | Wire format push — **`peerAddress`**, no dual-read UUID | `implemented` | [push-payload.md](./contracts/push-payload.md) — infrastruttura: SYS-PUSH |
...
| **PROM-PERSONAL-CONTACTS** | Rubrica solo `address` — isolata da inbox/allow list | `implemented` | [PROM-PERSONAL-CONTACTS.md](./promises/product/PROM-PERSONAL-CONTACTS.md) |
...
| **PROM-PEER-PROFILE** | Overlay profilo peer address-based + `get_profiles` | `implemented` | [PROM-PEER-PROFILE.md](./promises/product/PROM-PEER-PROFILE.md) |
...
| **PROM-CHAT-PEER-KEY** | Chat per `peer_address`, no `thread_id` | `implemented` | [PROM-CHAT-PEER-KEY.md](./promises/product/PROM-CHAT-PEER-KEY.md) |
...
| **PROM-SHAREABLE-LINK** | Link condivisibili stabili — equivalenza a strati link vs chiave messaggistica | `implemented` | [PROM-SHAREABLE-LINK.md](./promises/product/PROM-SHAREABLE-LINK.md) |
...
| **PROM-CONVERSATION-SCOPE** | Ambito unico conversazione attiva (account + `peer_address` + sessione) | `implemented` | [PROM-CONVERSATION-SCOPE.md](./promises/product/PROM-CONVERSATION-SCOPE.md) |
...
| **SURF-INBOX** | Lista conversazioni per `peer_address` + `get_profiles` | `implemented` | PROM-LIST-FILTER, PROM-REALTIME-ARCHIVE, PROM-CHAT-PEER-KEY | [SURF-INBOX.md](./surfaces/SURF-INBOX.md) |
| **SURF-CHAT** | Conversazione 1:1 keyed su `peer_address` | `implemented` | PROM-CHAT-PEER-KEY, PROM-MESSAGE-STATUS, PROM-OUTBOUND-SEND, PROM-CHAT-MEDIA, PROM-SHAREABLE-LINK, PROM-CONVERSATION-SCOPE, PROM-MESSAGE-MENTION, PROM-MESSAGE-REACTIONS, PROM-BOTTOM-ANCHOR | [SURF-CHAT.md](./surfaces/SURF-CHAT.md) |
| **SURF-CONTACTS** | Rubrica solo `address` | `implemented` | PROM-LIST-FILTER, PROM-PERSONAL-CONTACTS | [SURF-CONTACTS.md](./surfaces/SURF-CONTACTS.md) |
| **SURF-ALLOWLIST** | Persone consentite per `allowed_address` | `implemented` | PROM-LIST-FILTER, PROM-RECEPTION-FILTER | [SURF-ALLOWLIST.md](./surfaces/SURF-ALLOWLIST.md) |
...
| **SURF-PEER-PROFILE** | Scheda profilo peer address-based + `get_profiles` | `implemented` | PROM-PEER-PROFILE, PROM-OVERLAY-DISMISS, PROM-SHAREABLE-LINK | [SURF-PEER-PROFILE.md](./surfaces/SURF-PEER-PROFILE.md) |
...
| **SURF-NOTIFICATIONS** | Web Push, service worker — payload `peerAddress` (no dual-read) | `implemented` | PROM-PUSH-NOTIFY, SYS-PUSH, PROM-CONVERSATION-SCOPE | [SURF-NOTIFICATIONS.md](./surfaces/SURF-NOTIFICATIONS.md) |
