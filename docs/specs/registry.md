...
| **PROM-PUSH-NOTIFY** | Push multi-device / multi-account, anteprima, soppressione, **politica sync** (amend) | `draft` | [PROM-PUSH-NOTIFY.md](./promises/product/PROM-PUSH-NOTIFY.md) |
...
| **SURF-NOTIFICATIONS** | Web Push, service worker, permesso browser, **sync scope** (amend) | `draft` | PROM-PUSH-NOTIFY, SYS-PUSH | [SURF-NOTIFICATIONS.md](./surfaces/SURF-NOTIFICATIONS.md) |
