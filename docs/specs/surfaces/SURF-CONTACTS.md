...
| **SURF-CONTACTS-023** | Messaggistica verso esterni da rubrica (scope attuale) (solo salvataggio rubrica) |
...
| SURF-CONTACTS-023 | `compose_service.dart` — errore contatto esterno |
